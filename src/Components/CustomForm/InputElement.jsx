...
export const InputElement = ({field, formData, handleChange, fieldStyle, labelStyle, inputStyle}) => {
    ...
    <div
        ...
        >
           ...
           {field.type === "textarea" ? (
            ...
            onChange={(e) => { handleError(e);handleChange(e, field.name);}}
            >
              ...
              placeholder= {field.placeholder}
              value={formData[field.name]}
              className= {`${inputStyle} ${error ? 'border-red-500 focus:outline-red-500' : ''}` }
              onChange={(e) => {handleError(e); handleChange(e, field.name);}}
              >
              </input>
            )
